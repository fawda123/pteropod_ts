...
# Station similarities, within years
...
### Annual averages by water chemistry {.tabset}

The plots below show averages for salinity, temperature, and omega across months for the same year.  Points are sized by magnitude of the average and colored with transparency for the standard deviation of the estimates.  
...
toplo1b <- toplo1a %>% 
  group_by(station, var, yr, lat, lon) %>% 
  summarise(
...
Sites are clustered below based on water quality aggregations for the selected years.  

```{r}
selectInput('clyr1', 'Select year for clustering:', choices = c(2014, 2015, 2016), selected = 2014)
```
...
The plots below show averages for dissolution across months for the same year.  Points are sized by magnitude of the average and colored with transparency for the standard deviation of the estimates. 

### Annual averages by response measures {.tabset}
...
Sites are clustered below based on dissolutuion aggregations for the selected years.  

```{r}
selectInput('clyr2', 'Select year for clustering:', choices = c(2014, 2015, 2016), selected = 2014)
```
