...
column(12, 
       column(4, 
              selectInput('chm2', 'Select second chemistry variable:', choices = c('ara', 'araund', 'co3', 'ph', 'pco2', 'temp', 'oxy'), selected = 'temp')
       ),
...
column(12, 
       column(4, 
              selectInput('chm3', 'Select second chemistry variable:', choices = c('ara', 'araund', 'co3', 'ph', 'pco2', 'temp', 'oxy'), selected = 'temp')
       ),
