...
```{r ctdplo, fig.cap = "Depth profiles of minimum aragonite saturation state across seasons and stations.  Stations are grouped by clusters in Figure \\@fig(fig:clstmap).  Vertical lines indicate minimum saturation state of 1 (dashed) and 1.2 (dotted).  Point transparencies also correpond to the aragonite thresholds. ", out.width = "80%", fig.align = 'center'}
